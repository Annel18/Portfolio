...
export default function Experience() {
    ...
    const experiences = [
        ...
        },
        {
            ...
            img: ppImg,
            projects: reelIcon,
            description: '<p>I attained my qualification as an architect while working with P&P. Since 2015, I\'ve served as a <a href="https://en.wikipedia.org/wiki/Project_architect" style="text-decoration:underline" target="blank">project architect</a>, accumulating significant experience across diverse sectors, including Healthcare, Schools, Higher Education, Residential, and Science & Technology. This journey has provided me the opportunity to contribute to multiple award-winning projects. In addition to being a project architect on school and health projects, I worked extensively with BIM and excelled in CAD management. As part of the studio CAD Team, I have been instrumental in the creation of studio templates and workflow management.</br></br>Career path: <ul><li>Senior architect (2020 - 2023) </li><li>Architect (2015 - 2020) </br> - After qualifiction, I immediately fulfilled the role of Project Architect, coordinating the needs of clients and coordinating external consultants (Structural, Mechanical, Fire, Acoustic Engineers, Lanscape Architects...) as lead designer. </br>- I took on the responsability for the design managment of a building project </li><li>Architectural Assistant (2013 - 2015)</ul></p>'
        },
        {
